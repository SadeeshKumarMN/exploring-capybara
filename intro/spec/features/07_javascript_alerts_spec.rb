...
feature 'JavaScript Alerts: Interacting with Modals' do
  ...
  scenario 'JS Prompt: Enter a text in Prompt, Select [OK] => Message: You entered: text' do
  ...
  scenario 'JS Prompt: Select [OK] without entering the Prompt => Message: You entered:' do
...
scenario 'JS Prompt: Select [Cancel] without entering the Prompt => Message: You entered: null' do
